...
from sibley.task.media import play_sound, play_video_internal, show_image, show_text, play_video_vlc
import os
...
def _run_task(eeg, win, data_file, task):
    ...
    if task['name'] == 'text':
        ...
        print('_run_task.image: ' + str(task['params']['text'].encode('ascii', 'replace')))
